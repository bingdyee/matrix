...
import io.hikari.jooq.generated.tables.records.OauthCodeRecord;
...
public class OauthCode extends TableImpl<OauthCodeRecord> {
    ...
    private static final long serialVersionUID = 1479308043;

    /**
     * The reference instance of <code>hikari.oauth_code</code>
     */
    ...
    /**
     * The column <code>hikari.oauth_code.code</code>. 存储服务端系统生成的code的值(未加密).
     */
    public final TableField<OauthCodeRecord, String> CODE = createField("code", org.jooq.impl.SQLDataType.VARCHAR(256), this, "存储服务端系统生成的code的值(未加密).");

    /**
     * The column <code>hikari.oauth_code.authentication</code>. 存储将AuthorizationRequestHolder.java对象序列化后的二进制数据.
     */
    public final TableField<OauthCodeRecord, byte[]> AUTHENTICATION = createField("authentication", org.jooq.impl.SQLDataType.BLOB, this, "存储将AuthorizationRequestHolder.java对象序列化后的二进制数据.");

    /**
     * Create a <code>hikari.oauth_code</code> table reference
     */
    public OauthCode() {
    ...
    /**
     * Create an aliased <code>hikari.oauth_code</code> table reference
     */
