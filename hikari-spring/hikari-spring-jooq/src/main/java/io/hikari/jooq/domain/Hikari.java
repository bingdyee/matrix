...
public class Hikari extends SchemaImpl {
     ...
     */
    public final OauthAccessToken OAUTH_ACCESS_TOKEN = io.hikari.jooq.domain.tables.OauthAccessToken.OAUTH_ACCESS_TOKEN;

    /**
     * The table <code>hikari.oauth_approvals</code>.
     */
    public final OauthApprovals OAUTH_APPROVALS = io.hikari.jooq.domain.tables.OauthApprovals.OAUTH_APPROVALS;

    /**
     * The table <code>hikari.oauth_client_details</code>.
     */
    public final OauthClientDetails OAUTH_CLIENT_DETAILS = io.hikari.jooq.domain.tables.OauthClientDetails.OAUTH_CLIENT_DETAILS;

    /**
     * The table <code>hikari.oauth_client_token</code>.
     */
    public final OauthClientToken OAUTH_CLIENT_TOKEN = io.hikari.jooq.domain.tables.OauthClientToken.OAUTH_CLIENT_TOKEN;

    /**
     * The table <code>hikari.oauth_code</code>.
     */
    public final OauthCode OAUTH_CODE = io.hikari.jooq.domain.tables.OauthCode.OAUTH_CODE;

    /**
     * The table <code>hikari.oauth_refresh_token</code>.
     */
    public final OauthRefreshToken OAUTH_REFRESH_TOKEN = io.hikari.jooq.domain.tables.OauthRefreshToken.OAUTH_REFRESH_TOKEN;

    /**
     * The table <code>hikari.sys_role</code>.
     */
    public final SysRole SYS_ROLE = io.hikari.jooq.domain.tables.SysRole.SYS_ROLE;

    /**
     * The table <code>hikari.sys_user</code>.
     */
    public final SysUser SYS_USER = io.hikari.jooq.domain.tables.SysUser.SYS_USER;
